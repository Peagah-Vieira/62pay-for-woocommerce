    ...
    public function payment_fields() {
        ...
        <fieldset id="wc-62pay-cc-fields">
            <p class="form-row form-row-wide">
                <label for="wc-62pay-cc-number"><?php _e( 'Número do cartão', 'wc-62pay' ); ?> <span class="required">*</span></label>
                <input id="wc-62pay-cc-number" name="wc_62pay_cc_number" type="text" autocomplete="off" inputmode="numeric" placeholder="•••• •••• •••• ••••" />
            </p>
            <p class="form-row form-row-first">
                <label for="wc-62pay-cc-expiry"><?php _e( 'Validade (MM/AA)', 'wc-62pay' ); ?> <span class="required">*</span></label>
                <input id="wc-62pay-cc-expiry" name="wc_62pay_cc_expiry" type="text" autocomplete="off" placeholder="MM/AA" />
            </p>
            <p class="form-row form-row-last">
                <label for="wc-62pay-cc-cvc"><?php _e( 'CVC', 'wc-62pay' ); ?> <span class="required">*</span></label>
                <input id="wc-62pay-cc-cvc" name="wc_62pay_cc_cvc" type="password" autocomplete="off" placeholder="CVC" />
            </p>
            <div class="clear"></div>
            <p class="form-row form-row-wide">
                <label for="wc-62pay-cc-holder"><?php _e( 'Nome impresso no cartão', 'wc-62pay' ); ?> <span class="required">*</span></label>
